const TOOLS = {"date-duration-calculator": {"title": "Date Duration Calculator", "desc": "Calculate days, weeks, months, and years between two dates.", "category": "Date Math", "kind": "dateDiff", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-01-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-12-31"}], "manual": false}, "date-add-subtract": {"title": "Date Add or Subtract Calculator", "desc": "Add or subtract days, weeks, months, and years from a date.", "category": "Date Math", "kind": "dateAdd", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-14"}, {"id": "amount", "label": "Amount", "type": "number", "value": 30}, {"id": "unit", "label": "Unit", "type": "select", "value": "", "options": [["days", "Days"], ["weeks", "Weeks"], ["months", "Months"], ["years", "Years"]]}, {"id": "direction", "label": "Direction", "type": "select", "value": "", "options": [["add", "Add"], ["subtract", "Subtract"]]}], "manual": false}, "business-days-calculator": {"title": "Business Days Calculator", "desc": "Count weekdays between two dates and optionally exclude common weekend days.", "category": "Business Days", "kind": "businessDays", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-05-31"}, {"id": "includeEnd", "label": "Include end date", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}], "manual": false}, "age-calculator": {"title": "Age Calculator", "desc": "Calculate age in years, months, days, and total days.", "category": "Date Math", "kind": "age", "fields": [{"id": "birth", "label": "Birth date", "type": "date", "value": "1990-01-01"}, {"id": "asof", "label": "As of date", "type": "date", "value": "2026-05-14"}], "manual": false}, "countdown-calculator": {"title": "Countdown Calculator", "desc": "Calculate time remaining until a target date and time.", "category": "Date Math", "kind": "countdown", "fields": [{"id": "target", "label": "Target date/time", "type": "datetime-local", "value": "2026-12-31T23:59"}], "manual": false}, "week-number-calculator": {"title": "Week Number Calculator", "desc": "Find ISO week number, day of year, and quarter.", "category": "Date Math", "kind": "weekInfo", "fields": [{"id": "date", "label": "Date", "type": "date", "value": "2026-05-14"}], "manual": false}, "time-zone-converter": {"title": "Time Zone Offset Converter", "desc": "Convert time between UTC offsets.", "category": "Time Zones", "kind": "tzConvert", "fields": [{"id": "time", "label": "Local time", "type": "datetime-local", "value": "2026-05-14T09:00"}, {"id": "from", "label": "From UTC offset", "type": "number", "value": 0}, {"id": "to", "label": "To UTC offset", "type": "number", "value": -4}], "manual": false}, "unix-time-converter": {"title": "Unix Time Converter", "desc": "Convert Unix seconds and milliseconds to local and ISO time.", "category": "Timestamps", "kind": "unixTime", "fields": [{"id": "value", "label": "Unix timestamp", "type": "number", "value": 1778740000}, {"id": "mode", "label": "Mode", "type": "select", "value": "", "options": [["seconds", "Seconds"], ["milliseconds", "Milliseconds"]]}], "manual": false}, "iso-date-parser": {"title": "ISO Date Parser", "desc": "Parse ISO date strings into local time, UTC time, and Unix seconds.", "category": "Timestamps", "kind": "isoParse", "fields": [{"id": "value", "label": "ISO date", "type": "text", "value": "2026-05-14T09:00:00Z"}], "manual": false}, "quarter-calculator": {"title": "Quarter Calculator", "desc": "Find calendar quarter, start date, and end date.", "category": "Date Math", "kind": "quarter", "fields": [{"id": "date", "label": "Date", "type": "date", "value": "2026-05-14"}], "manual": false}, "leap-year-checker": {"title": "Leap Year Checker", "desc": "Check whether a year is a leap year.", "category": "Date Math", "kind": "leap", "fields": [{"id": "year", "label": "Year", "type": "number", "value": 2028}], "manual": false}, "working-hours-calculator": {"title": "Working Hours Calculator", "desc": "Estimate working hours between dates using weekday count.", "category": "Business Days", "kind": "workingHours", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-05-31"}, {"id": "hours", "label": "Hours per workday", "type": "number", "value": 8}], "manual": false}, "days-until-date-calculator": {"title": "Days Until Date Calculator", "desc": "Calculate how many days remain until a deadline, launch date, trip, or event.", "category": "Date Math", "kind": "dateDiff", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-15"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-12-31"}], "manual": false}, "days-since-date-calculator": {"title": "Days Since Date Calculator", "desc": "Calculate elapsed days since a start date for projects, habits, warranties, and records.", "category": "Date Math", "kind": "dateDiff", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-01-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-05-15"}], "manual": false}, "add-business-weeks-calculator": {"title": "Add Weeks to Date Calculator", "desc": "Add or subtract weeks from a date for planning sprints, lessons, trips, and reminders.", "category": "Date Math", "kind": "dateAdd", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-15"}, {"id": "amount", "label": "Weeks", "type": "number", "value": 6}, {"id": "unit", "label": "Unit", "type": "select", "value": "weeks", "options": [["weeks", "Weeks"], ["days", "Days"], ["months", "Months"], ["years", "Years"]]}, {"id": "direction", "label": "Direction", "type": "select", "value": "", "options": [["add", "Add"], ["subtract", "Subtract"]]}], "manual": false}, "project-business-days-calculator": {"title": "Project Business Days Calculator", "desc": "Count weekdays between project dates and estimate working-day capacity.", "category": "Business Days", "kind": "businessDays", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-06-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-06-30"}, {"id": "includeEnd", "label": "Include end date", "type": "select", "value": "yes", "options": [["yes", "Yes"], ["no", "No"]]}], "manual": false}, "utc-offset-meeting-converter": {"title": "UTC Offset Meeting Converter", "desc": "Convert a meeting time between two UTC offsets for remote teams and scheduling notes.", "category": "Time Zones", "kind": "tzConvert", "fields": [{"id": "time", "label": "Meeting time", "type": "datetime-local", "value": "2026-05-15T09:00"}, {"id": "from", "label": "From UTC offset", "type": "number", "value": 8}, {"id": "to", "label": "To UTC offset", "type": "number", "value": -4}], "manual": false}, "timestamp-to-iso-converter": {"title": "Timestamp to ISO Converter", "desc": "Convert Unix timestamps to ISO and local time for logs, APIs, and debugging.", "category": "Timestamps", "kind": "unixTime", "fields": [{"id": "value", "label": "Unix timestamp", "type": "number", "value": 1778740000}, {"id": "mode", "label": "Mode", "type": "select", "value": "", "options": [["seconds", "Seconds"], ["milliseconds", "Milliseconds"]]}], "manual": false}, "iso-to-unix-converter": {"title": "ISO to Unix Converter", "desc": "Parse an ISO date string into local time, UTC, and Unix seconds.", "category": "Timestamps", "kind": "isoParse", "fields": [{"id": "value", "label": "ISO date", "type": "text", "value": "2026-05-15T08:00:00Z"}], "manual": false}, "school-year-age-calculator": {"title": "School Year Age Calculator", "desc": "Calculate a learner age on a specific school, camp, or program date.", "category": "Date Math", "kind": "age", "fields": [{"id": "birth", "label": "Birth date", "type": "date", "value": "2012-09-01"}, {"id": "asof", "label": "As of date", "type": "date", "value": "2026-09-01"}], "manual": false}, "advanced-date-duration-calculator": {"title": "Advanced Date Duration Calculator", "desc": "Calculate days, weeks, months, and years between two dates. Use this focused variant for advanced workflows and long-tail search scenarios.", "category": "Date Math", "kind": "dateDiff", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-01-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-12-31"}], "manual": false}, "quick-date-add-subtract": {"title": "Quick Date Add or Subtract Calculator", "desc": "Add or subtract days, weeks, months, and years from a date. Use this focused variant for quick workflows and long-tail search scenarios.", "category": "Date Math", "kind": "dateAdd", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-14"}, {"id": "amount", "label": "Amount", "type": "number", "value": 30}, {"id": "unit", "label": "Unit", "type": "select", "value": "", "options": [["days", "Days"], ["weeks", "Weeks"], ["months", "Months"], ["years", "Years"]]}, {"id": "direction", "label": "Direction", "type": "select", "value": "", "options": [["add", "Add"], ["subtract", "Subtract"]]}], "manual": false}, "planning-business-days-calculator": {"title": "Planning Business Days Calculator", "desc": "Count weekdays between two dates and optionally exclude common weekend days. Use this focused variant for planning workflows and long-tail search scenarios.", "category": "Business Days", "kind": "businessDays", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-05-31"}, {"id": "includeEnd", "label": "Include end date", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}], "manual": false}, "mobile-age-calculator": {"title": "Mobile Age Calculator", "desc": "Calculate age in years, months, days, and total days. Use this focused variant for mobile workflows and long-tail search scenarios.", "category": "Date Math", "kind": "age", "fields": [{"id": "birth", "label": "Birth date", "type": "date", "value": "1990-01-01"}, {"id": "asof", "label": "As of date", "type": "date", "value": "2026-05-14"}], "manual": false}, "small-business-countdown-calculator": {"title": "Small Business Countdown Calculator", "desc": "Calculate time remaining until a target date and time. Use this focused variant for small business workflows and long-tail search scenarios.", "category": "Date Math", "kind": "countdown", "fields": [{"id": "target", "label": "Target date/time", "type": "datetime-local", "value": "2026-12-31T23:59"}], "manual": false}, "creator-week-number-calculator": {"title": "Creator Week Number Calculator", "desc": "Find ISO week number, day of year, and quarter. Use this focused variant for creator workflows and long-tail search scenarios.", "category": "Date Math", "kind": "weekInfo", "fields": [{"id": "date", "label": "Date", "type": "date", "value": "2026-05-14"}], "manual": false}, "student-time-zone-converter": {"title": "Student Time Zone Offset Converter", "desc": "Convert time between UTC offsets. Use this focused variant for student workflows and long-tail search scenarios.", "category": "Time Zones", "kind": "tzConvert", "fields": [{"id": "time", "label": "Local time", "type": "datetime-local", "value": "2026-05-14T09:00"}, {"id": "from", "label": "From UTC offset", "type": "number", "value": 0}, {"id": "to", "label": "To UTC offset", "type": "number", "value": -4}], "manual": false}, "team-unix-time-converter": {"title": "Team Unix Time Converter", "desc": "Convert Unix seconds and milliseconds to local and ISO time. Use this focused variant for team workflows and long-tail search scenarios.", "category": "Timestamps", "kind": "unixTime", "fields": [{"id": "value", "label": "Unix timestamp", "type": "number", "value": 1778740000}, {"id": "mode", "label": "Mode", "type": "select", "value": "", "options": [["seconds", "Seconds"], ["milliseconds", "Milliseconds"]]}], "manual": false}, "audit-iso-date-parser": {"title": "Audit ISO Date Parser", "desc": "Parse ISO date strings into local time, UTC time, and Unix seconds. Use this focused variant for audit workflows and long-tail search scenarios.", "category": "Timestamps", "kind": "isoParse", "fields": [{"id": "value", "label": "ISO date", "type": "text", "value": "2026-05-14T09:00:00Z"}], "manual": false}, "checklist-quarter-calculator": {"title": "Checklist Quarter Calculator", "desc": "Find calendar quarter, start date, and end date. Use this focused variant for checklist workflows and long-tail search scenarios.", "category": "Date Math", "kind": "quarter", "fields": [{"id": "date", "label": "Date", "type": "date", "value": "2026-05-14"}], "manual": false}, "campaign-leap-year-checker": {"title": "Campaign Leap Year Checker", "desc": "Check whether a year is a leap year. Use this focused variant for campaign workflows and long-tail search scenarios.", "category": "Date Math", "kind": "leap", "fields": [{"id": "year", "label": "Year", "type": "number", "value": 2028}], "manual": false}, "batch-working-hours-calculator": {"title": "Batch Working Hours Calculator", "desc": "Estimate working hours between dates using weekday count. Use this focused variant for batch workflows and long-tail search scenarios.", "category": "Business Days", "kind": "workingHours", "fields": [{"id": "start", "label": "Start date", "type": "date", "value": "2026-05-01"}, {"id": "end", "label": "End date", "type": "date", "value": "2026-05-31"}, {"id": "hours", "label": "Hours per workday", "type": "number", "value": 8}], "manual": false}};
